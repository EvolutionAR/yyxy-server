...
const pageURL = 'https://192.168.255.255' //  客户端访问的外网端口443
const HttpPageURL = 'http://192.168.255.255' // 客户端访问的外网端口80
module.exports = appInfo => {
  ...
  commonConfig['serverIp'] = '192.168.255.255' //外网ip
  ...
  commonConfig['componentUrl'] = 'https://192.168.255.255' // 外网访问的443端口
  commonConfig['logger'] = {
